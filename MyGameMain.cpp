...
void  MyGameMain_Finalize()
{
	...
	case TaskFlag::Rule:	Rule::Finalize(); break;
...
void  MyGameMain_UpDate()
{
	...
	if (actTask != nextTask) {
		...
		case TaskFlag::Rule:	Rule::Initialize(); break;
			//以下必要に応じて追加
		}
	}
	//現在のタスクの実行・更新処理を呼びだす
	...
	case TaskFlag::Rule:	nextTask = Rule::UpDate(); break;
		//以下必要に応じて追加
	}
}
//-----------------------------------------------------------------------------
...
void  MyGameMain_Render2D()
{
	...
	case TaskFlag::Rule:	Rule::Render(); break;
		//以下必要に応じて追加
	}
}
